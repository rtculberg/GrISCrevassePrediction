...
function calculateStrain(out_dir, vx_in, vy_in, tiffinfo, filt_name, kernel, thick_file,...
...
geotiffwrite(eXXOut, exGrid, tiffinfo.SpatialRef, 'GeoKeyDirectoryTag',tiffinfo.GeoTIFFTags.GeoKeyDirectoryTag);
geotiffwrite(eYYOut, eyGrid, tiffinfo.SpatialRef, 'GeoKeyDirectoryTag',tiffinfo.GeoTIFFTags.GeoKeyDirectoryTag);
geotiffwrite(eXYOut, exyGrid, tiffinfo.SpatialRef, 'GeoKeyDirectoryTag',tiffinfo.GeoTIFFTags.GeoKeyDirectoryTag);
